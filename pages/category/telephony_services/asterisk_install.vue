<template>
  <div class="antiowerflow_container">
    ...
    <section class="lumex_team joc" id="s_cov19">
      ...
      <div class="team_right ast1 cctv txt3">
        <a href="" class="primary_button vertical-button">
          <span>Asterisk</span>
          <svg>
            <path
    ...
    <section class="category_diogram category_diogram2 joc2" id="s_auto">
      <div class="diogram_left">
        <div class="cloud__block4 jt">
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs42 txt3">{{ $t("tsai5_1") }}</h3>
      ...
      <div class="diogram_right cat_block-img ast2_img np_fix txt3">
        <a href="" class="primary_button vertical-button">
    ...
    <section class="lumex_team joc" id="s_cov19">
      ...
      <div class="team_right ast3 cctv txt3" style="height: 50%;">
        <a href="" class="primary_button vertical-button">
          <span>Asterisk</span>
          <svg>
            <path
    ...
    <h3 class="h_title fs28 txt3" style="margin:auto; padding-top: calc(100% / 9);padding-bottom: calc(100% / 9);">{{ $t("tsai10") }}</h3>
    <Footer />
  </div>
</template>
